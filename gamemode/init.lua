...
CLASS_CONFIG["terrorist"].REPLACEMENT_WEAPONS["weapon_ar2"] = "weapon_m249"
...
CLASS_CONFIG["terrorist"].MAX_AMMO["ar2"] = 300 -- m249
...
CLASS_CONFIG["terrorist"].PICKUP_AMMO["ar2"] = 50 -- m249
...
CLASS_CONFIG["counterterrorist"].REPLACEMENT_WEAPONS["weapon_ar2"] = "weapon_m249"
...
CLASS_CONFIG["counterterrorist"].MAX_AMMO["ar2"] = 300 -- m249
...
CLASS_CONFIG["counterterrorist"].PICKUP_AMMO["ar2"] = 50 -- m249
...
function GM:Think()
	...
	for _,npc in pairs(ents.FindByClass("npc_*")) do
		if (npc:IsNPC() && !IsValid(npc:GetEnemy()) && npc:GetClass() != "npc_barnacle" && npc:GetClass() != "npc_citizen" && npc:GetClass() != "npc_manhack") then
			if (!string.find(npc:GetClass(), "headcrab")) then
